 ...
 * \class StyleBToggleMetric
 */
class StyleBToggleMetric : public IToggleMetric {
  Q_OBJECT
public:
  explicit StyleBToggleMetric(MyUiStyle *style) : IToggleMetric(style) {
...
private:
  ...
  static constexpr qreal Height = 0.4;
  static constexpr qreal Radius = 0.2;
